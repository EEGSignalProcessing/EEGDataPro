classdef eegdatapro_v10App < handle
    %
    % Usage:
    %     app.eegdatapro_v10App
    ...
    properties (Constant)
        AppPathBase = {'/eegdatapro_v10/code'};
        AppClass = 'eegdatapro_v10App';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = eegdatapro_v10App()
        ...
        function startApp(obj)
            ...
            mlock;
            eegdatapro_v10App.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'eegdatapro_toolbox_main')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong eegdatapro_toolbox_main
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'eegdatapro_toolbox_main').getString, ...
            ...
            if nargout(@eegdatapro_toolbox_main) == 0
                eval('eegdatapro_toolbox_main');
            else
                obj.AppHandle = eval('eegdatapro_toolbox_main');
            end
